...
class FrontendStoryBlockCatalogModuleTests(unittest.TestCase):
    def test_story_block_catalog_helpers_work_without_browser_dom(self) -> None:
        ...
        self.assertIn("text_input", payload["knownTypes"])
        ...
        self.assertIn("text_input", payload["tagTypes"]["localizable"])
        ...
        self.assertTrue(any(row["type"] == "text_input" and row["nativeStatus"] == "full" for row in payload["runtimeRows"]))

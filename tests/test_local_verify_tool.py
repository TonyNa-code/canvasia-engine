...
class LocalVerifyToolTests(unittest.TestCase):
    ...
    def test_discovery_uses_editor_entrypoint_and_frontend_tests(self) -> None:
        ...
        self.assertIn("modules/dashboard_production.js", module_scripts)
        self.assertIn("modules/project_runtime_settings_panel.js", module_scripts)
        ...
        self.assertIn("modules/api_endpoints.js", module_scripts)
        self.assertIn("modules/asset_import_rules.js", module_scripts)
        self.assertIn("modules/module_guard.js", module_scripts)
        self.assertIn("modules/voice_match_review_panel.js", module_scripts)
        self.assertIn("modules/timed_choice_editor.js", module_scripts)
        self.assertIn("modules/text_pacing_editor.js", module_scripts)
        self.assertIn("modules/rich_text_editor.js", module_scripts)
        self.assertIn("modules/variables.js", module_scripts)
        self.assertIn("modules/project_variable_governance.js", module_scripts)
        self.assertIn("modules/visual_effects.js", module_scripts)
        self.assertIn("modules/particle_performance.js", module_scripts)
        ...
        self.assertIn("test_frontend_dashboard_production_module.py", frontend_tests)
        self.assertIn("test_frontend_project_runtime_settings_panel_module.py", frontend_tests)
        ...
        self.assertIn("test_frontend_runtime_data_module.py", frontend_tests)
        self.assertIn("test_frontend_runtime_storage_module.py", frontend_tests)
        self.assertIn("test_frontend_runtime_ui_skin_module.py", frontend_tests)
        self.assertIn("test_frontend_runtime_visual_constants_module.py", frontend_tests)
        self.assertIn("test_frontend_api_endpoints_module.py", frontend_tests)
        self.assertIn("test_frontend_asset_import_rules_module.py", frontend_tests)
        self.assertIn("test_frontend_module_guard_module.py", frontend_tests)
        ...
        self.assertIn("test_frontend_particle_performance_module.py", frontend_tests)
        self.assertIn("test_frontend_runtime_particle_quality_module.py", frontend_tests)
        self.assertIn("test_frontend_runtime_particle_renderer_module.py", frontend_tests)
        self.assertIn("test_frontend_runtime_mobile_reader_module.py", frontend_tests)
        self.assertIn("test_frontend_runtime_timed_choices_module.py", frontend_tests)
        self.assertIn("test_frontend_timed_choice_editor_module.py", frontend_tests)
        self.assertIn("test_frontend_runtime_text_pacing_module.py", frontend_tests)
        self.assertIn("test_frontend_text_pacing_editor_module.py", frontend_tests)
        self.assertIn("test_frontend_runtime_story_text_module.py", frontend_tests)
        self.assertIn("test_frontend_rich_text_editor_module.py", frontend_tests)
    ...
    def test_profiles_build_expected_ci_like_steps(self) -> None:
        ...
        self.assertTrue(any("prototype_editor/modules/api_endpoints.js" in command for command in commands))
        self.assertTrue(any("prototype_editor/modules/beginner_assets_guide.js" in command for command in commands))
        self.assertTrue(any("prototype_editor/modules/module_guard.js" in command for command in commands))
        self.assertTrue(any("prototype_editor/modules/asset_import_rules.js" in command for command in commands))
        ...
        self.assertTrue(any("prototype_editor/modules/video_transport_editor.js" in command for command in commands))
        ...
        self.assertTrue(any("prototype_editor/modules/dashboard_production.js" in command for command in commands))
        self.assertTrue(any("prototype_editor/modules/project_runtime_settings_panel.js" in command for command in commands))
        self.assertTrue(any("prototype_editor/modules/project_variable_governance.js" in command for command in commands))
        ...
        self.assertTrue(any("editor_project_presentation.py" in command for command in commands))
        self.assertTrue(any("editor_snapshot_cache.py" in command for command in commands))
        self.assertTrue(any("export_icon.py" in command for command in commands))
        self.assertTrue(any("export_provenance_verifier.py" in command for command in commands))
        self.assertTrue(any("export_release_artifacts.py" in command for command in commands))
        self.assertTrue(any("export_runtime_module_registry.py" in command for command in commands))
        self.assertTrue(any("native_runtime_export_commands.py" in command for command in commands))
        self.assertTrue(any("native_runtime_export_digest.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_player_view.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_speaker_focus.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_dialogue_camera.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_voice_reactive_motion.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_timed_choices.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_text_pacing.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_rich_text.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_story_text.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_video_transport.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_playback_lifecycle.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_rich_text_renderer.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_character_renderer.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_stage_renderer.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_surface_cache.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_rollback.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_text_history.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_text_history_overlay.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_save_slots.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_save_overlay.py" in command for command in commands))
        ...
        self.assertTrue(any("native_runtime/runtime_text_input.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_vn_quality.py" in command for command in commands))
        self.assertTrue(any("native_runtime/runtime_particles.py" in command for command in commands))
        self.assertTrue(any("project_variable_migration.py" in command for command in commands))
        self.assertTrue(any("test_editor_infrastructure.py" in command for command in commands))
        self.assertTrue(any("test_editor_project_presentation.py" in command for command in commands))
        self.assertTrue(any("test_frontend_api_endpoints_module.py" in command for command in commands))
        self.assertTrue(any("test_frontend_asset_import_rules_module.py" in command for command in commands))
        self.assertTrue(any("test_frontend_module_guard_module.py" in command for command in commands))
        self.assertTrue(any("test_export_icon.py" in command for command in commands))
        self.assertTrue(any("test_export_provenance_verifier.py" in command for command in commands))
        self.assertTrue(any("test_export_release_artifacts.py" in command for command in commands))
        self.assertTrue(any("test_export_runtime_module_registry.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_export_commands.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_export_digest.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_player_view.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_speaker_focus.py" in command for command in commands))
        self.assertTrue(any("test_speaker_focus_contract.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_dialogue_camera.py" in command for command in commands))
        self.assertTrue(any("test_dialogue_camera_contract.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_voice_reactive_motion.py" in command for command in commands))
        self.assertTrue(any("test_voice_reactive_motion_contract.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_timed_choices.py" in command for command in commands))
        self.assertTrue(any("test_timed_choice_contract.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_text_pacing.py" in command for command in commands))
        self.assertTrue(any("test_text_pacing_contract.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_story_text.py" in command for command in commands))
        self.assertTrue(any("test_story_text_contract.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_video_transport.py" in command for command in commands))
        self.assertTrue(any("test_video_transport_contract.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_playback_lifecycle.py" in command for command in commands))
        self.assertTrue(any("test_playback_lifecycle_contract.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_stage_renderer.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_surface_cache.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_rollback.py" in command for command in commands))
        ...
        self.assertTrue(any("test_native_runtime_text_input.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_save_thumbnails.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_particles.py" in command for command in commands))
        self.assertTrue(any("test_particle_quality_contract.py" in command for command in commands))
        self.assertTrue(any("test_project_variable_migration.py" in command for command in commands))
        ...
        self.assertTrue(any("test_frontend_dashboard_production_module.py" in command for command in commands))
        self.assertTrue(any("test_frontend_project_runtime_settings_panel_module.py" in command for command in commands))
        self.assertTrue(any("test_frontend_project_variable_governance_module.py" in command for command in commands))
        ...
        self.assertTrue(any("test_frontend_runtime_data_module.py" in command for command in commands))
        self.assertTrue(any("test_frontend_runtime_dom_refs_module.py" in command for command in commands))
        self.assertTrue(any("test_frontend_runtime_storage_module.py" in command for command in commands))
        self.assertTrue(any("test_frontend_runtime_save_portability_module.py" in command for command in commands))
        self.assertTrue(any("test_frontend_runtime_text_input_module.py" in command for command in commands))
        self.assertTrue(any("test_frontend_runtime_story_flow_module.py" in command for command in commands))
        self.assertTrue(any("test_frontend_runtime_achievements_module.py" in command for command in commands))
        self.assertTrue(any("test_frontend_runtime_ui_skin_module.py" in command for command in commands))
        self.assertTrue(any("test_frontend_runtime_visual_constants_module.py" in command for command in commands))
        ...
        self.assertTrue(any("export_player_template/runtime_dom_refs.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_storage.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_save_portability.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_persistent_variables.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_text_history.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_save_slots.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_story_flow.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_achievements.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_ui_skin.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_speaker_focus.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_dialogue_camera.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_voice_reactive_motion.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_timed_choices.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_text_pacing.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_rich_text.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_story_text.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_video_transport.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_playback_lifecycle.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_text_input.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_visual_constants.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_particle_quality.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_particle_renderer.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_mobile_reader.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_mobile_reader_ui.js" in command for command in commands))
        self.assertTrue(any("export_player_template/runtime_asset_pipeline.js" in command for command in commands))
        self.assertTrue(any("test_frontend_runtime_asset_pipeline_module.py" in command for command in commands))
        ...
        self.assertTrue(any("test_native_runtime_dialog_panel.py" in command for command in commands))
        self.assertTrue(any("test_native_runtime_preload.py" in command for command in commands))

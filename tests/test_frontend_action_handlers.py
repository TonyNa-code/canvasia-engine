...
class FrontendActionHandlerTests(unittest.TestCase):
    ...
    def test_command_palette_wiring_stays_integrated_with_editor_actions(self) -> None:
        ...
        self.assertIn('draftBlock.type === "background"', normalize_script_import_block)
        self.assertIn('draftBlock.type === "music_play"', normalize_script_import_block)
        self.assertIn('draftBlock.type === "sfx_play"', normalize_script_import_block)
        self.assertIn('draftBlock.type === "screen_fade"', normalize_script_import_block)
        self.assertIn('draftBlock.type === "jump"', normalize_script_import_block)
        self.assertIn("draftBlock.voiceHint", normalize_script_import_block)
        self.assertIn("findImportedAssetIdByHint", normalize_script_import_block)
        self.assertIn("CHOICE_CONTINUE_TARGET", normalize_script_import_block)

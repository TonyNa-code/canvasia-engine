...
class FrontendActionHandlerTests(unittest.TestCase):
    ...
    def test_command_palette_wiring_stays_integrated_with_editor_actions(self) -> None:
        ...
        self.assertIn("getStoryTemplateRecommendedPanelItems", get_story_template_panel_items)
        ...
        self.assertIn("recommendationReason", get_story_template_button_description)
        self.assertIn("story-template-recommendation-badge", render_story_template_button)

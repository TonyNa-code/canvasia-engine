...
CHARACTER_STAGE_COMPOSER_PATH = EDITOR_DIR / "modules" / "character_stage_composer.js"
...
class FrontendActionHandlerTests(unittest.TestCase):
    ...
    def test_command_palette_wiring_stays_integrated_with_editor_actions(self) -> None:
        ...
        story_template_panel_source = (EDITOR_DIR / "modules" / "story_template_panel.js").read_text(
            encoding="utf-8"
        )
        scene_mood_source = (EDITOR_DIR / "modules" / "scene_mood_recipes.js").read_text(encoding="utf-8")
        script_importer_source = (EDITOR_DIR / "modules" / "script_importer.js").read_text(encoding="utf-8")
        script_importer_panel_source = (EDITOR_DIR / "modules" / "script_importer_panel.js").read_text(
            encoding="utf-8"
        )
        ...
        get_story_template_panel_items = _extract_function_source(app_source, "getStoryTemplatePanelItems")
        get_story_template_button_description = _extract_function_source(
            app_source,
        ...
        normalize_script_import_block = _extract_function_source(app_source, "normalizeScriptImportBlockForScene")
        insert_script_import_blocks = _extract_function_source(app_source, "insertScriptImportBlocks")
        normalize_assistant_draft_block = _extract_function_source(app_source, "normalizeAssistantDraftBlockForScene")
        ...
        apply_scene_mood_recipe = _extract_function_source(app_source, "applySceneMoodRecipe")
        render_scene_mood_recipe_panel = _extract_function_source(app_source, "renderSceneMoodRecipePanel")
        apply_story_template_speaker = _extract_function_source(app_source, "applyStoryTemplateSpeaker")
        apply_story_template_choice_options = _extract_function_source(app_source, "applyStoryTemplateChoiceOptions")
        finalize_story_template_blocks = _extract_function_source(app_source, "finalizeStoryTemplateBlocks")
        get_choice_target_label = _extract_function_source(app_source, "getChoiceTargetLabel")
        build_choice_option_next_snapshot = _extract_function_source(app_source, "buildChoiceOptionNextSnapshot")
        choose_preview_option = _extract_function_source(app_source, "choosePreviewOption")
        choose_preview_regression_option = _extract_function_source(app_source, "choosePreviewRegressionOption")

        self.assertIn("./modules/command_palette.js", html)
        self.assertIn("./modules/scene_mood_recipes.js", html)
        self.assertIn("./modules/story_template_application.js", html)
        self.assertIn("./modules/story_template_panel.js", html)
        self.assertIn("./modules/script_importer_panel.js", html)
        self.assertIn("./modules/script_import_mapping.js", html)
        ...
        self.assertIn("renderSceneMoodRecipePanel", render_scene_mood_recipe_panel)
        self.assertIn("applySceneMoodRecipe", scene_mood_source)
        ...
        self.assertIn("getBlockLabel", render_story_editor_mode_banner)
        self.assertIn("storyTemplatePanelTools.getStoryTemplatePanelItems", get_story_template_panel_items)
        self.assertIn("storyTemplatePanelTools.renderStoryTemplateGrid", render_story_template_grid)
        self.assertIn("selectedSceneBlocks", get_context)
        self.assertIn("storyTemplatePanelTools.renderStoryTemplateButton", render_story_template_button)
        self.assertIn("storyTemplatePanelTools.getStoryTemplateButtonDescription", get_story_template_button_description)
        self.assertIn('data-template-id="${escapeHtml(templateId)}"', story_template_panel_source)
        self.assertIn("recommendationReason", story_template_panel_source)
        self.assertIn("story-template-recommendation-badge", story_template_panel_source)
        self.assertIn("story-template-button-plan", story_template_panel_source)
        self.assertIn("story-template-button-meta", story_template_panel_source)
        self.assertIn("renderStoryTemplateGrid()", render_story_screen)
        self.assertIn("refs.storyTemplatePanel", render_story_screen)
        self.assertIn("oneClickPolishDigest", get_context)
        self.assertIn("hasOneClickPolishReceipt", get_context)
        self.assertIn("projectOneClickPolishInFlight", get_context)
        self.assertIn("projectHistoryCanUndo", get_context)
        self.assertIn("projectHistoryCanRedo", get_context)
        self.assertIn("sceneMoodCanApply", get_context)
        self.assertIn("sceneMoodRecipeSuggestions", get_context)
        self.assertIn("release-one-click-polish", command_palette_source)
        self.assertIn("release-copy-polish-receipt", command_palette_source)
        self.assertIn("release-preview-regression", command_palette_source)
        self.assertIn("safety-create-checkpoint", command_palette_source)
        self.assertIn("safety-restore-previous", command_palette_source)
        self.assertIn("mood-recipe-warm-confession", command_palette_source)
        self.assertIn("apply-scene-mood-recipe", command_palette_source)
        ...
        self.assertIn("scriptImporterPanelTools.renderScriptImporterPanel", render_script_importer_panel)
        self.assertIn("getScriptImporterSampleDraft", app_source)
        self.assertIn("scriptImporterPanelTools.getScriptImporterSampleDraft", app_source)
        self.assertIn("scriptImporterPanelTools.getScriptImportSummaryText", app_source)
        self.assertIn("scriptImporterPanelTools.getScriptImportInsertedSummaryText", app_source)
        self.assertIn("buildScriptDraftPreviewLines", script_importer_panel_source)
        self.assertIn("script-importer-capability-grid", script_importer_panel_source)
        self.assertIn("parseScriptDraftToBlocks", parse_current_script_import_draft)
        self.assertIn("parseStageDirectionLine", script_importer_source)
        self.assertIn("parseWaitLine", script_importer_source)
        self.assertIn("parseJumpLine", script_importer_source)
        self.assertIn("parseConditionLine", script_importer_source)
        self.assertIn("parseConditionRuleClause", script_importer_source)
        self.assertIn("parseVariableActionLine", script_importer_source)
        self.assertIn("parseVoiceLine", script_importer_source)
        self.assertIn("ROUTE_DRAFT_TYPES", script_importer_source)
        self.assertIn("VARIABLE_DRAFT_TYPES", script_importer_source)
        self.assertIn("STAGE_DRAFT_TYPES", script_importer_source)
        self.assertIn("findImportedAssetIdByHint", script_import_mapping_source)
        self.assertIn("findImportedCharacterByHint", script_import_mapping_source)
        self.assertIn("findImportedSceneIdByHint", script_import_mapping_source)
        self.assertIn("findImportedVariableIdByHint", script_import_mapping_source)
        self.assertIn("normalizeImportedDraftBlockForScene", script_import_mapping_source)
        self.assertIn('draftBlock.type === "background"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "music_play"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "sfx_play"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "video_play"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "credits_roll"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "wait"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "screen_shake"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "screen_flash"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "screen_fade"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "camera_zoom"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "camera_pan"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "screen_filter"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "depth_blur"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "particle_effect"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "variable_set"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "variable_add"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "jump"', script_import_mapping_source)
        self.assertIn('draftBlock.type === "condition"', script_import_mapping_source)
        self.assertIn("draftBlock.voiceHint", script_import_mapping_source)
        self.assertIn("findAssetIdByHint", script_import_mapping_source)
        self.assertIn("choiceContinueTarget", script_import_mapping_source)
        self.assertIn("scriptImportMappingTools.normalizeImportedDraftBlockForScene", normalize_script_import_block)
        self.assertIn("defaultCharacterStage: DEFAULT_CHARACTER_STAGE", normalize_script_import_block)
        self.assertIn("getSafeCharacterStage", normalize_script_import_block)
        self.assertIn("getSafeTextSpeed", normalize_script_import_block)
        self.assertIn("findVariableIdByHint: findImportedVariableIdByHint", normalize_script_import_block)
        self.assertIn("normalizeChoiceEffect", normalize_script_import_block)
        self.assertIn("getSafeConditionOperator", normalize_script_import_block)
        self.assertIn("normalizeVariableValue", normalize_script_import_block)
        self.assertIn("choiceContinueTarget: CHOICE_CONTINUE_TARGET", normalize_script_import_block)
        self.assertIn('"background"', normalize_assistant_draft_block)
        self.assertIn('"music_play"', normalize_assistant_draft_block)
        self.assertIn('"sfx_play"', normalize_assistant_draft_block)
        self.assertIn('"video_play"', normalize_assistant_draft_block)
        self.assertIn('"credits_roll"', normalize_assistant_draft_block)
        self.assertIn('"wait"', normalize_assistant_draft_block)
        self.assertIn('"screen_shake"', normalize_assistant_draft_block)
        self.assertIn('"screen_flash"', normalize_assistant_draft_block)
        self.assertIn('"camera_zoom"', normalize_assistant_draft_block)
        self.assertIn('"camera_pan"', normalize_assistant_draft_block)
        self.assertIn('"screen_filter"', normalize_assistant_draft_block)
        self.assertIn('"depth_blur"', normalize_assistant_draft_block)
        self.assertIn('"particle_effect"', normalize_assistant_draft_block)
        self.assertIn('"variable_set"', normalize_assistant_draft_block)
        self.assertIn('"variable_add"', normalize_assistant_draft_block)
        self.assertIn('"jump"', normalize_assistant_draft_block)
        self.assertIn('"condition"', normalize_assistant_draft_block)
        self.assertIn("getSafeAssetIdByType", normalize_assistant_draft_block)
        self.assertIn("getSafeVideoFit", normalize_assistant_draft_block)
        self.assertIn("getSafeCharacterStage", normalize_assistant_draft_block)
        self.assertIn("getSafeTextSpeed", normalize_assistant_draft_block)
        self.assertIn("normalizeChoiceEffect", normalize_assistant_draft_block)
        self.assertIn("createConditionBranchId", normalize_assistant_draft_block)
        self.assertIn("normalizeVariableValue", normalize_assistant_draft_block)
        self.assertIn('blockType === "variable_set"', normalize_assistant_draft_block)
        self.assertIn('blockType === "variable_add"', normalize_assistant_draft_block)
        self.assertIn("getSafeCameraZoomAction", normalize_assistant_draft_block)
        self.assertIn("getSafeScreenFilterAction", normalize_assistant_draft_block)
        self.assertIn("getSafeDepthBlurAction", normalize_assistant_draft_block)
        self.assertIn("normalizeParticleEffectConfig", normalize_assistant_draft_block)
        self.assertIn("getSafeCreditsDuration", normalize_assistant_draft_block)
        self.assertIn("getSafeWaitDurationSeconds", normalize_assistant_draft_block)
        self.assertIn("getSafeSceneId(block.targetSceneId", normalize_assistant_draft_block)
        self.assertIn('data-action="preview-script-import"', script_importer_panel_source)
        self.assertIn('data-action="insert-script-import-blocks"', script_importer_panel_source)
        ...
        self.assertIn("const insertedSummary = getScriptImportInsertedSummaryText(draftBlocks)", insert_script_import_blocks)
        self.assertIn("successMessage: insertedSummary", insert_script_import_blocks)
        self.assertIn("showToast(insertedSummary)", insert_script_import_blocks)
        ...
        self.assertIn("const validation = getCurrentValidation()", get_context)
        ...
        self.assertIn("storyBlockActionTools.buildAddBlockSuccessFeedback", add_block)
        self.assertIn("showToast(feedback.toastMessage)", add_block)
        ...
        self.assertIn("storyTemplateApplicationTools.buildStoryTemplateBlocks", build_story_template_blocks)
        self.assertIn("getStoryTemplateBlockRecipes", build_story_template_blocks)
        self.assertIn("selectedCharacterId: state.selectedCharacterId", build_story_template_blocks)
        self.assertIn("getStoryTemplateVariableRequirement(templateId)", apply_story_template)
        self.assertIn("ensureStarterVariables({", apply_story_template)
        self.assertIn("buildStoryTemplateApplicationSummary", apply_story_template)
        self.assertIn("templateSummary.message", apply_story_template)
        self.assertIn("storyTemplateApplicationTools.applyStoryTemplateSpeaker", apply_story_template_speaker)
        self.assertIn("storyTemplateApplicationTools.applyStoryTemplateChoiceOptions", apply_story_template_choice_options)
        self.assertIn("storyTemplateApplicationTools.finalizeStoryTemplateBlocks", finalize_story_template_blocks)
        self.assertIn('if (!String(block.position ?? "").trim())', story_template_application_source)
        self.assertIn("block.position = getDefaultCharacterPosition(speakerId)", story_template_application_source)
        self.assertIn("choiceOptions", story_template_application_source)
        self.assertIn("buildStoryTemplateChoiceEffect", story_template_application_source)
        self.assertIn('block.endMode = "after_block"', story_template_application_source)
        self.assertIn("block.endBlockId = endBlock.id", story_template_application_source)
        self.assertIn("CHOICE_CONTINUE_TARGET", app_source)
        self.assertIn("isChoiceContinueTarget(targetSceneId)", get_choice_target_label)
        self.assertIn('return "继续下一张卡"', get_choice_target_label)
        self.assertIn("isChoiceContinueTarget(targetSceneId)", build_choice_option_next_snapshot)
        self.assertIn("current.blockIndex + 1", build_choice_option_next_snapshot)
        self.assertIn("buildChoiceOptionNextSnapshot(current, option, nextVariables)", choose_preview_option)
        self.assertIn("buildChoiceOptionNextSnapshot(current, option, nextVariables)", choose_preview_regression_option)
        self.assertIn("choiceContinueTarget: CHOICE_CONTINUE_TARGET", app_source)
        self.assertNotIn('templateId === "opening_intro"', build_story_template_blocks)
        self.assertIn("const storyBlockActionTools", command_palette_source)
        self.assertIn("STORY_BLOCK_COMMAND_ID_BY_ACTION", command_palette_source)
        self.assertIn('"add-dialogue": "insert-dialogue"', command_palette_source)
        self.assertIn('"add-wait": "insert-wait"', command_palette_source)
        self.assertIn("buildStoryBlockCommands(context)", command_palette_source)
        ...
        self.assertIn('id: "template-branch-merge"', command_palette_source)
        self.assertIn('templateId: "playable_scene"', command_palette_source)
        self.assertIn('templateId: "affection_choice"', command_palette_source)
        self.assertIn('templateId: "ending_credits"', command_palette_source)
        self.assertIn("getAddBlockActionEntries", command_palette_source)
        ...
        self.assertIn("getStoryTemplateRecommendationCommandIds", command_palette_source)
        ...
        self.assertIn("getStoryTemplateVariableRequirement", story_templates_source)
        self.assertIn("getStoryTemplatePanelItems", story_templates_source)
        self.assertIn("getStoryTemplateSceneSignals", story_templates_source)
        self.assertIn("getStoryTemplateRecommendationPlan", story_templates_source)
        self.assertIn("getStoryTemplateRecommendedPanelItems", story_templates_source)
        self.assertIn("getRecommendedWorkflowTemplate", editor_mode_source)
        self.assertIn("getWorkflowTemplateSummary", editor_mode_source)
        self.assertIn("getStoryTemplateRecommendationPlan", editor_mode_source)
        self.assertIn("const storyBlockActionTools", editor_mode_source)
        self.assertIn("BEGINNER_STORY_STRUCTURE_ACTIONS", editor_mode_source)
        self.assertIn("storyBlockActionTools.getBeginnerAddBlockActions()", editor_mode_source)
        ...
        self.assertIn("target != CHOICE_CONTINUE_TARGET", native_runtime_source)
        self.assertIn("str(target_scene_id).strip() != CHOICE_CONTINUE_TARGET", native_runtime_source)
        ...
        self.assertIn(".story-template-button.is-recommended", styles)
        self.assertIn(".story-template-recommendation-badge", styles)
        self.assertIn(".story-template-button-plan", styles)
        ...
        self.assertIn(".script-importer-capability-grid", styles)
    ...
    def test_project_validation_cache_is_wired_for_repeated_release_actions(self) -> None:
        html = INDEX_PATH.read_text(encoding="utf-8")
        source = APP_PATH.read_text(encoding="utf-8")
        get_current_validation = _extract_function_source(source, "getCurrentValidation")
        refresh_current_validation = _extract_function_source(source, "refreshCurrentValidation")
        mark_project_data_revision_changed = _extract_function_source(source, "markProjectDataRevisionChanged")
        hydrate_project_runtime = _extract_function_source(source, "hydrateProjectRuntime")
        reload_project_data = _extract_function_source(source, "reloadProjectData")
        apply_scene_to_local_state = _extract_function_source(source, "applySceneToLocalState")
        handle_click = _extract_function_source(source, "handleClick")

        self.assertIn("./modules/validation_cache.js", html)
        self.assertIn("window.CanvasiaEditorValidationCache", source)
        self.assertIn("const projectValidationCache = validationCacheTools.createValidationCache()", source)
        self.assertIn("projectValidationCache.getOrCompute", get_current_validation)
        self.assertIn("storyChangeVersion", get_current_validation)
        self.assertIn("force: options.force === true", get_current_validation)
        self.assertIn("state.validation = validationCacheTools.EMPTY_VALIDATION", get_current_validation)
        self.assertIn("updateTopbar()", refresh_current_validation)
        self.assertIn("state.projectDataRevision += 1", mark_project_data_revision_changed)
        self.assertIn("resetProjectValidationCache()", mark_project_data_revision_changed)
        self.assertIn("markProjectDataRevisionChanged()", hydrate_project_runtime)
        self.assertIn("refreshCurrentValidation({ force: true, updateTopbar: false })", hydrate_project_runtime)
        self.assertIn("markProjectDataRevisionChanged()", reload_project_data)
        self.assertIn("refreshCurrentValidation({ force: true, updateTopbar: false })", reload_project_data)
        self.assertIn("markProjectDataRevisionChanged()", apply_scene_to_local_state)
        self.assertIn("refreshCurrentValidation({ force: true })", apply_scene_to_local_state)
        self.assertIn('action === "run-project-inspection"', handle_click)
        self.assertIn("refreshCurrentValidation()", handle_click)
        self.assertNotIn("state.validation = runValidation(state.data);", handle_click)
    ...
    def test_export_player_surfaces_runtime_preload_size_context(self) -> None:
        ...
        start_preload = _extract_function_source(source, "startRuntimeAssetPreload")
        start_prefetch = _extract_function_source(source, "startRuntimeScenePrefetch")
        meta_text = _extract_function_source(source, "getRuntimePreloadMetaText")

        self.assertIn('from "./runtime_asset_pipeline.js"', source)
        self.assertIn("createRuntimeAssetPipeline({", start_preload)
        self.assertIn("preloadManifest: data.buildInfo.runtimePreloadManifest", start_preload)
        self.assertIn("runtimeSettings: getProjectRuntimeSettings(data.project)", start_preload)
        self.assertIn("state.runtimeAssetPipeline?.prefetch?.(snapshot)", start_prefetch)
        self.assertIn("state.runtimeAssetPipeline?.getStatusText?.()", status_text)
        self.assertIn("state.runtimeAssetPipeline?.getMetaText?.()", meta_text)
        self.assertNotIn("runtimeScenePrefetchedAssetIds", source)
        self.assertNotIn("runtimePreloadedAssetIds", source)
        self.assertNotIn("function formatRuntimePreloadSize", source)
        self.assertNotIn("function formatRuntimePreloadBytes", source)
    ...
    def test_major_inspection_sections_have_focus_anchors(self) -> None:
        source = APP_PATH.read_text(encoding="utf-8")
        styles = (ROOT_DIR / "prototype_editor" / "styles.css").read_text(encoding="utf-8")
        ...
        self.assertIn("const INSPECTION_SECTION_SHORTCUTS", source)
        self.assertIn("function renderInspectionSectionShortcutRail", source)
        self.assertIn("${renderInspectionSectionShortcutRail()}", source)
        self.assertIn("巡检快速导航", source)
        self.assertIn(".inspection-shortcut-panel", styles)
        self.assertIn('"inspection-section": shortcut.id', source)
        for section_id in [
            "choice-consequence",
            "stage-direction",
            "production-backlog",
    ...
    def test_exported_runtimes_honor_bgm_fade_controls(self) -> None:
        ...
        music_scope_source = (EDITOR_DIR / "modules" / "music_range_scope.js").read_text(encoding="utf-8")
        ...
        music_scope_effective_end = _extract_function_source(music_scope_source, "getMusicRangeEffectiveEndBlockId")
        music_scope_label = _extract_function_source(music_scope_source, "getMusicRangeBlockLabel")
        music_scope_summary = _extract_function_source(music_scope_source, "getMusicRangeSummaryFromValues")
        music_scope_timeline = _extract_function_source(music_scope_source, "getMusicRangeTimelineFromValues")
        music_scope_diagnostics = _extract_function_source(music_scope_source, "buildMusicRangeDiagnostics")
        ...
        self.assertIn("data-music-range-summary", music_editor_template)
        self.assertIn("data-music-range-count", music_editor_template)
        self.assertIn("data-has-range-candidates", music_editor_template)
        self.assertIn("renderMusicRangeHealthChips(rangeDiagnostics)", music_editor_template)
        ...
        self.assertIn("getMusicRangeDiagnostics", music_editor)
        self.assertIn("renderMusicRangeHealthChips", music_editor)
        self.assertIn("musicRangeScopeTools.getMusicRangeEffectiveEndBlockId(getSelectedScene(), block)", music_effective_end)
        self.assertIn("candidates[0]?.id", music_scope_effective_end)
        self.assertIn("musicRangeScopeTools.renderMusicRangeEndBlockOptions(getSelectedScene(), block", music_options)
        self.assertIn("sceneIndex >= 0 ? sceneIndex + 1 : index + 1", music_scope_label)
        self.assertIn("第 ${displayIndex} 张", music_scope_label)
        self.assertIn('safeEndMode === "scene_end"', music_scope_summary)
        self.assertIn('safeEndMode === "after_block"', music_scope_summary)
        self.assertIn("options.hasRangeCandidates === false", music_scope_summary)
        self.assertIn("options.currentBlockId", music_scope_summary)
        self.assertIn("spanCount", music_scope_summary)
        self.assertIn("共覆盖 ${spanCount} 张卡片", music_scope_summary)
        self.assertIn("musicRangeScopeTools.getMusicRangeSummaryFromValues(getSelectedScene()", music_summary)
        self.assertIn("getMusicRangeTimelineFromValues", app_source)
        self.assertIn("modeLabel: \"指定结束卡\"", music_scope_timeline)
        self.assertIn("countLabel: `覆盖 ${spanCount} 张`", music_scope_timeline)
        self.assertIn("自定义范围有效", music_scope_diagnostics)
        self.assertIn("结束点早于播放点", music_scope_diagnostics)
        self.assertIn("selectedEndBlockId", music_preview)
        self.assertIn("timelineStart", music_preview)
        self.assertIn('document.querySelector("[data-music-range-summary]")', music_preview)
    ...
    def test_sfx_card_volume_reaches_preview_export_and_native_runtime(self) -> None:
        app_source = APP_PATH.read_text(encoding="utf-8")
        story_editor_source = (EDITOR_DIR / "modules" / "story_block_editors.js").read_text(encoding="utf-8")
        sfx_editor_source = (EDITOR_DIR / "modules" / "sfx_transport_editor.js").read_text(encoding="utf-8")
        player_source = PLAYER_PATH.read_text(encoding="utf-8")
        native_source = NATIVE_RUNTIME_PATH.read_text(encoding="utf-8")

        sfx_editor_template = _extract_function_source(story_editor_source, "renderSfxPlayEditor")
        collect_edited_block = _extract_function_source(app_source, "collectEditedBlock")
        sync_preview_sfx = _extract_function_source(app_source, "syncPreviewSfxPlayback")
        sync_runtime_sfx = _extract_function_source(player_source, "syncSfxPlayback")
        update_runtime_audio = _extract_function_source(player_source, "updateRuntimeAudioVolumes")

        self.assertIn("renderSfxTransportEditor(block)", sfx_editor_template)
        self.assertIn('id="editorSfxVolume"', sfx_editor_source)
        self.assertIn("sfxTransportEditorTools.readSfxTransportEditor", collect_edited_block)
        self.assertIn("previewSfxTransportController.sync", sync_preview_sfx)
        self.assertIn("sfxTransportController.sync", sync_runtime_sfx)
        self.assertIn("sfxTransportController.updateVolumes", update_runtime_audio)
        self.assertIn("self.sfx_transport_controller.play(block, cue_id=cue_id)", native_source)
        self.assertIn("source: dict | str | None", native_source)
    ...
    def test_scene_production_board_export_actions_are_wired(self) -> None:
        ...
        self.assertIn('data-action="apply-story-template-to-scene"', source)
        self.assertIn("exportSceneProductionBoardMarkdown();", markdown_block)
        self.assertIn("exportSceneProductionBoardCsv();", csv_block)
        self.assertIn('action === "apply-story-template-to-scene"', click_handler)
        self.assertIn("void applyStoryTemplateToScene(actionTarget.dataset.sceneId, actionTarget.dataset.templateId)", click_handler)
        self.assertIn("function buildSceneProductionBoard()", source)
        self.assertIn("function renderSceneProductionBoardPanel()", source)
        self.assertIn("function applyStoryTemplateToScene(", source)
    ...
    def test_screenplay_export_actions_are_wired(self) -> None:
        ...
        renpy_block_start = click_handler.index('action === "export-renpy-draft"')
        renpy_manifest_block_start = click_handler.index('action === "export-renpy-draft-manifest"')
        csv_block_end = renpy_block_start
        renpy_block_end = renpy_manifest_block_start
        renpy_manifest_block_end = click_handler.index('action === "export-director-cue-sheet-markdown"', renpy_manifest_block_start)
        markdown_block = click_handler[markdown_block_start:csv_block_start]
        csv_block = click_handler[csv_block_start:csv_block_end]
        renpy_block = click_handler[renpy_block_start:renpy_block_end]
        renpy_manifest_block = click_handler[renpy_manifest_block_start:renpy_manifest_block_end]

        self.assertIn("const screenplayExporterTools = window.CanvasiaEditorScreenplayExporter", source)
        self.assertIn("const renpyExporterTools = window.CanvasiaEditorRenpyExporter", source)
        self.assertIn('data-action="export-screenplay-markdown"', source)
        self.assertIn('data-action="export-screenplay-csv"', source)
        self.assertIn('data-action="export-renpy-draft"', source)
        self.assertIn('data-action="export-renpy-draft-manifest"', source)
        self.assertIn("exportScreenplayMarkdown();", markdown_block)
        self.assertIn("exportScreenplayCsv();", csv_block)
        self.assertIn("exportRenpyDraftScript();", renpy_block)
        self.assertIn("exportRenpyDraftManifest();", renpy_manifest_block)
        self.assertIn("function buildScreenplayExport()", source)
        self.assertIn("function buildRenpyDraftExport()", source)
        ...
        self.assertIn("function exportRenpyDraftScript()", source)
        self.assertIn("function exportRenpyDraftManifest()", source)
        ...
        self.assertIn("renpyExporterTools.buildRenpyDraftExport", source)
        self.assertIn("renpyExporterTools.getRenpyDraftStatusDigest", source)
        self.assertIn("完整剧本台本", source)
        self.assertIn("Ren'Py 草稿", source)
    ...
    def test_production_backlog_export_actions_are_wired(self) -> None:
        ...
        self.assertIn("function renderProductionSprintPhase(", source)
        self.assertIn("function renderProductionBacklogPanel(", source)
        self.assertIn("editorCommonTools.renderQuickActionButton", source)
        ...
        self.assertIn("productionBacklogTools.buildProductionSprintPlan", source)
        self.assertIn("productionBacklogTools.getProductionBacklogStatusDigest", source)
        self.assertIn("下一步制作 Sprint", source)
    ...
    def test_beginner_dashboard_export_step_requires_real_export_record(self) -> None:
        ...
        self.assertIn("return beginnerTutorialTools.buildBeginnerDashboardWorkflow({", workflow)
        self.assertIn("data: state.data", workflow)
        self.assertIn("starterKitOverview: getStarterKitOverview()", workflow)
        self.assertIn("productionOverview: buildDashboardProductionOverview(routeOverview)", workflow)
        self.assertIn("validation: state.validation", workflow)
        self.assertIn("previewProgress: hasBeginnerTutorialPreviewProgress()", workflow)
        self.assertIn("lastExportResult: state.lastExportResult", workflow)
        self.assertIn("regressionResult: state.inspectionRegressionResult", workflow)
        self.assertIn("const releaseCandidateReadiness = state.lastExportResult?.releaseCandidateReadinessEstimate ?? {};", workflow)
        self.assertIn("releaseCandidateManifest: state.lastExportResult", workflow)
        self.assertIn("releaseCandidateReadiness.desktopPreviewPercent", workflow)
        self.assertNotIn("buildReleaseCandidateManifest(routeOverview)", workflow)
        self.assertIn("function buildBeginnerDashboardWorkflow", beginner_tutorial_source)
        self.assertIn("const previewReady =", beginner_tutorial_source)
        self.assertIn("const hasCleanExportRecord =", beginner_tutorial_source)
        self.assertIn("const releaseCandidateReady =", beginner_tutorial_source)
        self.assertIn("试玩一次并保存", beginner_tutorial_source)
        self.assertIn("跑巡检和回归试玩", beginner_tutorial_source)
        self.assertIn("导出发布候选版", beginner_tutorial_source)
        self.assertIn("已导出，缺 ${exportMissingAssetCount} 个素材", beginner_tutorial_source)
        self.assertIn("补齐后再导出才更接近可交付", beginner_tutorial_source)
        self.assertIn('action: "export-build"', beginner_tutorial_source)
        self.assertIn('dataset: { "export-target": "web" }', beginner_tutorial_source)
        self.assertIn('action: "focus-asset-gap"', beginner_tutorial_source)
        self.assertIn('dataset: { "asset-filter-mode": "urgent_missing" }', beginner_tutorial_source)
        self.assertIn('dataset: { screen: "inspection" }', beginner_tutorial_source)
    ...
    def test_dashboard_scene_playable_checklist_is_rendered(self) -> None:
        ...
        self.assertIn('data-scene-checklist-item="${escapeHtml(item.id)}"', checklist_item_renderer)
        self.assertIn('data-scene-checklist-label="${escapeHtml(item.action.label ?? item.text)}"', checklist_item_renderer)
    ...
    def test_dashboard_scene_checklist_action_opens_story_with_focus_hint(self) -> None:
        source = APP_PATH.read_text(encoding="utf-8")
        styles = STYLES_PATH.read_text(encoding="utf-8")
        dashboard_production_source = (EDITOR_DIR / "modules" / "dashboard_production.js").read_text(encoding="utf-8")
        handle_click = _extract_function_source(source, "handleClick")
        select_scene = _extract_function_source(source, "selectScene")
        open_scene = _extract_function_source(source, "openSceneFromRouteMap")
        focus_hint = _extract_function_source(source, "getSceneChecklistFocusHint")
        focus_getter = _extract_function_source(source, "getActiveSceneChecklistFocus")
        focus_renderer = _extract_function_source(source, "renderStorySceneChecklistFocusHint")
        dismiss_focus = _extract_function_source(source, "dismissSceneChecklistFocus")
        story_planner = _extract_function_source(source, "renderStoryScenePlanner")

        self.assertIn("sceneChecklistFocus: null", source)
        self.assertIn("checklistItem: actionTarget.dataset.sceneChecklistItem", handle_click)
        self.assertIn("checklistLabel: actionTarget.dataset.sceneChecklistLabel", handle_click)
        self.assertIn("state.sceneChecklistFocus = null", select_scene)
        self.assertIn("keepChecklistFocus", select_scene)
        self.assertIn("getSceneChecklistFocusHint(options.checklistItem, options.checklistLabel)", open_scene)
        self.assertIn("state.sceneChecklistFocus = focusHint ? { ...focusHint, sceneId: safeSceneId } : null", open_scene)
        self.assertIn("focusHint.title", open_scene)
        self.assertIn("dashboardProductionTools.getSceneChecklistFocusHint", focus_hint)
        self.assertIn("music", dashboard_production_source)
        ...
        self.assertIn("sceneChecklistFocusTools.buildDismissAction(focus)", focus_renderer)
        self.assertIn("renderQuickActionButton(action", focus_renderer)
        self.assertIn("story-scene-checklist-actions", focus_renderer)
        self.assertIn('action === "dismiss-scene-checklist-focus"', handle_click)
        self.assertIn("dismissSceneChecklistFocus();", handle_click)
        self.assertIn("sceneChecklistFocusTools.buildDismissFeedback(focus)", dismiss_focus)
        self.assertIn("state.sceneChecklistFocus = null", dismiss_focus)
        self.assertIn("renderStoryScreen();", dismiss_focus)
        self.assertIn("场景内容没有改变", SCENE_CHECKLIST_FOCUS_PATH.read_text(encoding="utf-8"))
    ...
    def test_scene_checklist_add_actions_clear_completed_focus_after_save(self) -> None:
        ...
        self.assertIn("storyBlockActionTools.getAddBlockActionConfigByBlockType(safeBlockType)", add_block)
        self.assertIn("storyBlockActionTools.buildAddBlockSuccessFeedback(", add_block)
        self.assertIn("successMessage: feedback.statusMessage", add_block)
        self.assertIn("completeSceneChecklistFocus(options.checklistCompleteItem", add_block)
        self.assertIn("const completedChecklist = completeSceneChecklistFocus", add_block)
        self.assertIn("if (!completedChecklist)", add_block)
        self.assertIn("showToast(feedback.toastMessage)", add_block)
        self.assertIn("sceneChecklistFocusTools.shouldCompleteFocus(focus, checklistItem)", complete_focus)
        self.assertIn("return false", complete_focus)
        ...
        self.assertIn("return true", complete_focus)
    ...
    def test_export_build_refreshes_current_progress_surface(self) -> None:
        ...
        self.assertIn("renpyQualityStatus", export_build)
        self.assertIn("renpyQualityMarkdownPublicUrl", source)
        self.assertIn("打开 Ren'Py 自检报告", source)
        self.assertIn("renpyQualityReportPublicUrl", source)
        self.assertIn("打开 Ren'Py 自检 JSON", source)
        self.assertIn("renpyVerifierPublicUrl", source)
    ...
    def test_character_stage_flip_is_wired_through_editor_export_and_native_runtime(self) -> None:
        app_source = APP_PATH.read_text(encoding="utf-8")
        composer_source = CHARACTER_STAGE_COMPOSER_PATH.read_text(encoding="utf-8")
        ...
        self.assertIn("characterStageComposerController.readStage()", read_stage)
        self.assertIn("characterStageComposerTools.renderCharacterStageControls", render_stage)
        self.assertIn("getCharacterStagePresetEntries", render_stage)
        self.assertIn("getCharacterStageAdjustmentEntries", render_stage)
        self.assertIn("characterStageComposerTools.renderCharacterStageLivePreview", live_preview)
        self.assertIn("characterStageComposerController.update", update_preview)
        self.assertIn("characterStageComposerController.update", update_preset_state)
        self.assertIn("editorCharacterFlipX", composer_source)
        self.assertIn("水平镜像立绘", composer_source)
        self.assertIn("apply-character-stage-preset", composer_source)
        self.assertIn("apply-custom-character-stage-preset", composer_source)
        self.assertIn("adjust-character-stage", composer_source)
        self.assertIn("save-character-stage-preset", composer_source)
        self.assertIn("delete-character-stage-preset", composer_source)
        self.assertIn("data-character-stage-preview-sprite", composer_source)
        self.assertIn("data-character-stage-preview-summary", composer_source)
        self.assertIn('aria-grabbed="false"', composer_source)
        self.assertIn("handlePointerDown", composer_source)
        self.assertIn("handlePointerMove", composer_source)
        self.assertIn("handleWheel", composer_source)
        ...
        self.assertIn("characterStageComposerController.applyBuiltInPreset", apply_preset)
        self.assertIn("characterStageComposerController.readPosition", position_getter)
        self.assertIn("characterStageComposerController.setPosition", position_setter)
        self.assertIn("characterStageComposerController.setStage", set_values)
        self.assertIn("characterStageComposerController.applyAdjustment", adjust_stage)
        self.assertIn("characterStageComposerController.handleKeyboard", keyboard_nudge)
        self.assertIn("event.shiftKey ? 10 : 2", composer_source)
        self.assertIn('event.code === "ArrowLeft"', composer_source)
        self.assertIn('event.code === "BracketRight"', composer_source)
        self.assertIn("handleCharacterStageKeyboardNudge(event)", app_source)
        self.assertIn('"apply-character-stage-preset"', app_source)
        self.assertIn('"apply-custom-character-stage-preset"', app_source)
        self.assertIn('"save-character-stage-preset"', app_source)
        self.assertIn('"delete-character-stage-preset"', app_source)
    ...
    def test_line_text_speed_override_reaches_preview_export_and_native_runtime(self) -> None:
        ...
        self.assertIn("export function resolveLocalizedRuntimeValue", runtime_i18n_source)
        self.assertIn("export function buildRuntimeLocalizationFallbackReport", runtime_i18n_source)
        self.assertIn("formatRuntimeLocalizationFallbackSummary", player_source)
        self.assertIn("getRuntimeLocalizationFallbackSummary", player_source)
        self.assertIn("recordRuntimeLocalizationFallback", player_source)
        ...
        self.assertIn("format_runtime_localization_fallback_summary", native_source)
    ...
    def test_web_runtime_exposes_explicit_history_step_controls(self) -> None:
        ...
        player_source = PLAYER_PATH.read_text(encoding="utf-8")
        dom_refs_source = (ROOT_DIR / "export_player_template" / "runtime_dom_refs.js").read_text(encoding="utf-8")
        ...
        self.assertIn('querySelectorAll?.("[id]")', dom_refs_source)
    ...
    def test_web_runtime_operation_guide_is_data_driven_and_keyboard_reachable(self) -> None:
        ...
        self.assertIn("refs.operationGuideButton", init_block)
        self.assertIn("refs.startOperationGuideButton", init_block)
        self.assertIn("refs.systemMenuOperationGuideButton", init_block)
    ...
    def test_web_runtime_applies_project_playback_defaults_before_player_overrides(self) -> None:
        ...
        self.assertIn('from "./runtime_asset_pipeline.js"', player_source)
        ...
        self.assertIn("runtimeSettings: getProjectRuntimeSettings(data.project)", runtime_asset_preload)
        self.assertIn("createRuntimeAssetPipeline({", runtime_asset_preload)

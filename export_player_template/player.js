...
import {
  PARTICLE_AREA_LABELS, PARTICLE_BLEND_LABELS, PARTICLE_COLOR_CURVE_LABELS, PARTICLE_COMBO_PRESET_CONFIGS,
  PARTICLE_COMBO_PRESET_LABELS, PARTICLE_CUSTOM_COMBO_LAYER_LIMIT, PARTICLE_EMISSION_MODE_LABELS,
  PARTICLE_EMITTER_SHAPE_LABELS, PARTICLE_FOLLOW_ANCHOR_LABELS, PARTICLE_FOLLOW_LABELS, PARTICLE_FORCE_FIELD_LABELS,
  ...
  CAMERA_ZOOM_STRENGTH_LABELS, CREDITS_BACKGROUND_LABELS, DEFAULT_PROJECT_DIALOG_BOX_CONFIG,
  DEFAULT_PROJECT_GAME_UI_CONFIG, DEPTH_BLUR_ACTION_LABELS, DEPTH_BLUR_FOCUS_LABELS, DEPTH_BLUR_STRENGTH_LABELS,
  EFFECT_DURATION_LABELS, FADE_ACTION_LABELS, FADE_COLOR_LABELS, FLASH_COLOR_LABELS, FLASH_INTENSITY_LABELS,
  MUSIC_END_MODE_LABELS, PROJECT_DIALOG_BOX_PRESETS, PROJECT_GAME_UI_PRESETS, SAVE_DIALOG_PAGE_SIZE,

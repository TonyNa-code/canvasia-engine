...
EXPORT_PLAYER_SCRIPT_FILES = (
    ...
    "runtime_particle_quality.js",
    "runtime_particle_renderer.js",
    "runtime_controls.js",
    "runtime_gamepad.js",
...
NATIVE_RUNTIME_PARTICLES_NAME = "runtime_particles.py"
...
NATIVE_RUNTIME_RICH_TEXT_NAME = "runtime_rich_text.py"
NATIVE_RUNTIME_STORY_TEXT_NAME = "runtime_story_text.py"
NATIVE_RUNTIME_RICH_TEXT_RENDERER_NAME = "runtime_rich_text_renderer.py"
...
NATIVE_RUNTIME_REQUIRED_MODULE_FILES = build_native_runtime_required_module_files(
    ...
    (
        ...
        NATIVE_RUNTIME_RICH_TEXT_NAME,
        NATIVE_RUNTIME_STORY_TEXT_NAME,
        NATIVE_RUNTIME_RICH_TEXT_RENDERER_NAME,
...
EXPORT_SHARED_QUALITY_FILE_MAP = {
    ...
    "exportPerformanceBudget": EXPORT_PERFORMANCE_BUDGET_JSON_NAME,
    "exportPerformanceBudgetReport": EXPORT_PERFORMANCE_BUDGET_REPORT_NAME,
    "exportPerformanceBudgetCsv": EXPORT_PERFORMANCE_BUDGET_CSV_NAME,
...
def write_export_provenance_verifier_files(build_dir: Path) -> dict:
    return write_export_provenance_verifier_files_impl(
        build_dir,
        provenance_file_name=EXPORT_PROVENANCE_FILE_NAME,
        protection_profile=EXPORT_PROTECTION_PROFILE,
        engine_signature=dict(EXPORT_ENGINE_SIGNATURE),
        script_name=EXPORT_PROVENANCE_VERIFIER_SCRIPT_NAME,
        mac_name=EXPORT_PROVENANCE_MAC_VERIFIER_NAME,
        linux_name=EXPORT_PROVENANCE_LINUX_VERIFIER_NAME,
        windows_name=EXPORT_PROVENANCE_WINDOWS_VERIFIER_NAME,
    )
...
def build_export_performance_budget_fields(quality_reports: dict, build_dir: Path) -> dict:
    return {
        "exportPerformanceBudgetName": quality_reports["exportPerformanceBudgetName"],
        "exportPerformanceBudgetPath": quality_reports["exportPerformanceBudgetPath"],
        "exportPerformanceBudgetPublicUrl": f"/exports/{build_dir.name}/{quality_reports['exportPerformanceBudgetName']}",
        "exportPerformanceBudgetReportName": quality_reports["exportPerformanceBudgetReportName"],
        "exportPerformanceBudgetReportPath": quality_reports["exportPerformanceBudgetReportPath"],
        "exportPerformanceBudgetReportPublicUrl": f"/exports/{build_dir.name}/{quality_reports['exportPerformanceBudgetReportName']}",
        "exportPerformanceBudgetCsvName": quality_reports["exportPerformanceBudgetCsvName"],
        "exportPerformanceBudgetCsvPath": quality_reports["exportPerformanceBudgetCsvPath"],
        "exportPerformanceBudgetCsvPublicUrl": f"/exports/{build_dir.name}/{quality_reports['exportPerformanceBudgetCsvName']}",
        "exportPerformanceBudgetStatus": quality_reports["exportPerformanceBudgetStatus"],
        "exportPerformanceBudgetScore": quality_reports["exportPerformanceBudgetScore"],
        "exportPerformanceBudgetIssueCount": quality_reports["exportPerformanceBudgetIssueCount"],
    }
...
def write_native_runtime_files(build_dir: Path, export_payload: dict) -> dict:
    ...
    return {
        ...
        "runtimeParticlesModuleName": NATIVE_RUNTIME_PARTICLES_NAME,
        "runtimeParticlesModulePath": str(build_dir / NATIVE_RUNTIME_PARTICLES_NAME),
        "runtimeI18nModuleName": NATIVE_RUNTIME_I18N_NAME,
        ...
        "runtimeRichTextModuleName": NATIVE_RUNTIME_RICH_TEXT_NAME,
        "runtimeRichTextModulePath": str(build_dir / NATIVE_RUNTIME_RICH_TEXT_NAME),
        "runtimeStoryTextModuleName": NATIVE_RUNTIME_STORY_TEXT_NAME,
        "runtimeStoryTextModulePath": str(build_dir / NATIVE_RUNTIME_STORY_TEXT_NAME),
        "runtimeRichTextRendererModuleName": NATIVE_RUNTIME_RICH_TEXT_RENDERER_NAME,
        "runtimeRichTextRendererModulePath": str(build_dir / NATIVE_RUNTIME_RICH_TEXT_RENDERER_NAME),
...
def export_native_runtime_build() -> dict:
    ...
    manifest = build_export_manifest(
        ...
        extra_files={
            ...
            **EXPORT_SHARED_QUALITY_FILE_MAP,
            ...
            "runtimeStoryTextModule": runtime_files["runtimeStoryTextModuleName"],
            "runtimeRichTextRendererModule": runtime_files["runtimeRichTextRendererModuleName"],
    ...
    internal_reports = [
        ...
        {"name": release_readiness["exportPerformanceBudgetReportName"], "description": "发布性能预算 Markdown，复查包体、首屏预加载和超大素材。"},
        {"name": release_readiness["exportPerformanceBudgetName"], "description": "机器可读发布性能预算 JSON。"},
        {"name": release_readiness["exportPerformanceBudgetCsvName"], "description": "可导入表格的发布性能预算 CSV。"},
        ...
        {"name": runtime_files["runtimeStoryTextModuleName"], "description": "原生 Runtime 富文本与句内节奏统一编排模块。"},
        {"name": runtime_files["runtimeRichTextRendererModuleName"], "description": "原生 Runtime 强调、低语、颜色和汉字注音排版模块。"},
    ...
    return {
        ...
        **build_export_performance_budget_fields(release_readiness, build_dir),
        ...
        "runtimeParticlesModuleName": runtime_files["runtimeParticlesModuleName"],
        "runtimeParticlesModulePath": runtime_files["runtimeParticlesModulePath"],
        "runtimeParticlesModulePublicUrl": f"/exports/{build_dir.name}/{runtime_files['runtimeParticlesModuleName']}",
        "runtimeI18nModuleName": runtime_files["runtimeI18nModuleName"],
        "runtimeI18nModulePath": runtime_files["runtimeI18nModulePath"],
        "runtimeI18nModulePublicUrl": f"/exports/{build_dir.name}/{runtime_files['runtimeI18nModuleName']}",
        ...
        "runtimeRichTextModuleName": runtime_files["runtimeRichTextModuleName"],
        "runtimeRichTextModulePath": runtime_files["runtimeRichTextModulePath"],
        "runtimeRichTextModulePublicUrl": f"/exports/{build_dir.name}/{runtime_files['runtimeRichTextModuleName']}",
        "runtimeStoryTextModuleName": runtime_files["runtimeStoryTextModuleName"],
        "runtimeStoryTextModulePath": runtime_files["runtimeStoryTextModulePath"],
        "runtimeStoryTextModulePublicUrl": f"/exports/{build_dir.name}/{runtime_files['runtimeStoryTextModuleName']}",
        "runtimeRichTextRendererModuleName": runtime_files["runtimeRichTextRendererModuleName"],
        "runtimeRichTextRendererModulePath": runtime_files["runtimeRichTextRendererModulePath"],
        "runtimeRichTextRendererModulePublicUrl": f"/exports/{build_dir.name}/{runtime_files['runtimeRichTextRendererModuleName']}",
...
def export_web_build() -> dict:
    ...
    manifest = build_export_manifest(
        ...
        extra_files={
            ...
            "playerRuntimeParticleQuality": "runtime_particle_quality.js",
            "playerRuntimeParticleRenderer": "runtime_particle_renderer.js",
            ...
            "playerRuntimeMobileReader": "runtime_mobile_reader.js",
            "playerRuntimeMobileReaderUi": "runtime_mobile_reader_ui.js",
            ...
            "playerRuntimeRichText": "runtime_rich_text.js",
            "playerRuntimeStoryText": "runtime_story_text.js",
...
def export_windows_nwjs_build() -> dict:
    ...
    manifest = build_export_manifest(
        ...
        extra_files={
            ...
            "appRuntimeParticleQuality": "app/runtime_particle_quality.js",
            "appRuntimeParticleRenderer": "app/runtime_particle_renderer.js",
            ...
            "appRuntimeMobileReader": "app/runtime_mobile_reader.js",
            "appRuntimeMobileReaderUi": "app/runtime_mobile_reader_ui.js",
            ...
            "appRuntimeRichText": "app/runtime_rich_text.js",
            "appRuntimeStoryText": "app/runtime_story_text.js",

...
NATIVE_RUNTIME_SYSTEM_MENU_NAME = "runtime_system_menu.py"
NATIVE_RUNTIME_SAVE_VAULT_NAME = "runtime_save_vault.py"
...
NATIVE_RUNTIME_REQUIRED_MODULE_FILES = build_native_runtime_required_module_files(
    ...
    (
        ...
        NATIVE_RUNTIME_SYSTEM_MENU_NAME,
        NATIVE_RUNTIME_SAVE_VAULT_NAME,
...
def write_native_runtime_files(build_dir: Path, export_payload: dict) -> dict:
    ...
    return {
        ...
        "runtimeTextHistoryModuleName": NATIVE_RUNTIME_TEXT_HISTORY_NAME,
        "runtimeTextHistoryModulePath": str(build_dir / NATIVE_RUNTIME_TEXT_HISTORY_NAME),
        "runtimeTextHistoryOverlayModuleName": NATIVE_RUNTIME_TEXT_HISTORY_OVERLAY_NAME,
        "runtimeTextHistoryOverlayModulePath": str(build_dir / NATIVE_RUNTIME_TEXT_HISTORY_OVERLAY_NAME),
...
def export_web_build() -> dict:
    ...
    manifest = build_export_manifest(
        ...
        extra_files={
            ...
            "playerJs": "player.js",
            **build_export_runtime_module_manifest("playerRuntime"),
...
def export_windows_nwjs_build() -> dict:
    ...
    manifest = build_export_manifest(
        ...
        extra_files={
            ...
            **build_export_runtime_module_manifest("appRuntime", "app"),

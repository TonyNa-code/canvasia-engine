...
- Command Palette with Cmd/Ctrl+K quick actions for project setup, navigation, story card insertion, scene templates, themes, tutorial access, and export flow

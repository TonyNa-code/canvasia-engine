...
- Context-aware Command Palette with Cmd/Ctrl+K quick actions for project setup, navigation, recommended next steps, story card insertion, scene templates, themes, tutorial access, and export flow

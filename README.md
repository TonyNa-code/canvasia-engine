...
| Area | Status | Notes |
| --- | --- | --- |
| Story and Branch Editing | Available | Visual cards, choices, jumps, variables, conditions, entry reachability route checks, scene production boards with pacing-aware recipe suggestions, full screenplay exports, director cue sheets, voice production sheets, variable influence reports, scene graph inspection, and plain-text script-to-card import. |

...
- Plain-text and Ren'Py-style script import that previews `Character: line`, quoted dialogue, narration, choices, `scene`, `show`, `hide`, `play / stop music`, `play sound`, `play video`, `shake`, `flash`, `zoom`, `pan`, `credits`, `voice`, and `jump` cues as editable story / staging / audio / video / camera / route cards

...
const REQUIRED_EDITOR_MODULES = Object.freeze([
  ...
  { globalName: "CanvasiaRuntimeTextPacing", script: "../export_player_template/runtime_text_pacing.js", label: "句内节奏系统" },
  { globalName: "CanvasiaRuntimeRichText", script: "../export_player_template/runtime_rich_text.js", label: "富文本表现系统" },
  { globalName: "CanvasiaRuntimeStoryText", script: "../export_player_template/runtime_story_text.js", label: "剧情文字统一解析系统" },
  { globalName: "CanvasiaRuntimeMusicTransport", script: "../export_player_template/runtime_music_transport.js", label: "音乐精确播放系统" },
  { globalName: "CanvasiaRuntimeVideoTransport", script: "../export_player_template/runtime_video_transport.js", label: "视频播放导演系统" },
  { globalName: "CanvasiaRuntimeSfxTransport", script: "../export_player_template/runtime_sfx_transport.js", label: "音效与环境声导演系统" },
  ...
  { globalName: "CanvasiaRuntimeCharacterCards", script: "../export_player_template/runtime_character_cards.js", label: "舞台角色卡渲染系统" },
  { globalName: "CanvasiaRuntimeDialogueCamera", script: "../export_player_template/runtime_dialogue_camera.js", label: "自动对话镜头系统" },
  { globalName: "CanvasiaRuntimeVoiceReactiveMotion", script: "../export_player_template/runtime_voice_reactive_motion.js", label: "语音驱动角色演技系统" },
  { globalName: "CanvasiaRuntimeTimedChoices", script: "../export_player_template/runtime_timed_choices.js", label: "限时选项系统" },
    ...
    { globalName: "CanvasiaRuntimeAchievements", script: "../export_player_template/runtime_achievements.js", label: "自定义成就系统" },
    ...
    { globalName: "CanvasiaEditorStoryBlockFactory", script: "./modules/story_block_factory.js", label: "剧情卡片默认值工厂" },
    { globalName: "CanvasiaEditorChoiceAvailability", script: "./modules/choice_availability_editor.js", label: "选项门控编辑器" },
    { globalName: "CanvasiaEditorTimedChoice", script: "./modules/timed_choice_editor.js", label: "限时选项编辑器" },
    ...
    { globalName: "CanvasiaEditorSfxTransport", script: "./modules/sfx_transport_editor.js", label: "音效与环境声编辑器" },
    ...
    { globalName: "CanvasiaEditorCharacterBlockingWorkspace", script: "./modules/character_blocking_workspace.js", label: "多人走位台" },
    { globalName: "CanvasiaEditorCharacterStageComposer", script: "./modules/character_stage_composer.js", label: "角色舞台构图器" },

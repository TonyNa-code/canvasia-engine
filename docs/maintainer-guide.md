...
- `prototype_editor/modules/production_backlog.js` owns cross-module production task aggregation and export formatting: route, scene, director cue, voice, choice, variable, asset dependency, asset rights, audio, stage, presentation, localization, runtime coverage, and unlockable-content issues are normalized into one prioritized work queue with Markdown and CSV exports. Keep future task scoring / ownership rules there instead of duplicating queue logic across inspection cards.

...
- `prototype_editor/modules/story_templates.js` owns reusable story template presets and block recipes. Add or tune scene templates there, while `app.js` should only translate recipes into real scene blocks.

...
- `prototype_editor/modules/localization_coverage.js` owns editor-side i18n coverage analysis and export formatting: supported-language discovery, chapter / scene / character / dialogue / narration / choice text coverage, missing translation checks, same-as-source warnings, Markdown, and CSV. Keep future translation QA and translator handoff logic there so runtime fallback logic and inspection UI stay separate.

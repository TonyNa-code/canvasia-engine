...
- `prototype_editor/modules/release_candidate_manifest.js` owns public-preview handoff manifests: project inventory, release deliverable status, risk register normalization, manual signoff checks, Markdown / CSV exports, and the inspection-page manifest card. Keep future tester / publisher handoff wording there; `app.js` should only assemble the current context and call the module.

...
| 存档与系统菜单 | 已支持带本机场景缩略图的正式存档 / 快速存档、旧存档兼容、主题、显示模式、文字速度、文字大小、文本框透明度、四路音量、角色 / 旁白语音混音和操作帮助 | 增加自定义按键映射、辅助功能和项目级菜单扩展 |
| 阅读体验 | 已支持项目字体族、项目字体素材、文本历史、语音回听、自动播放语音等待、持久化已读快进、逐步剧情回退、清屏隐藏和截图 | 后续补更多可访问性选项、触控映射和阅读偏好预设 |
| 输入设备 | 已支持键盘、鼠标和手柄；手柄可使用摇杆 / 十字键导航，确认 / 返回，并快捷打开历史、系统菜单、回退、自动播放和已读快进 | 后续补项目级自定义映射、震动反馈和更多设备实机档案 |

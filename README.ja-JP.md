...
| 領域 | 状態 | 説明 |
| --- | --- | --- |
| ストーリー / 分岐編集 | Available | カード、選択肢、ジャンプ、再利用サブシーンの呼び出し / 復帰、変数、条件分岐、入口到達可能性チェック、リズム分析に連動した配方提案つきシーン制作ボード、フル台本、Ren'Py draft export、ボイス制作シート、シーングラフ確認、台本テキストからカードへのインポートに対応。 |

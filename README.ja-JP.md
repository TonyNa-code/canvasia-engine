...
| 多言語 / i18n | Preview | プロジェクト言語設定、多言語カバレッジレポート、シーン / ストーリーカード翻訳の安全な CSV 再インポート、書き出しメタデータ、Web Runtime 言語切替、ネイティブ Runtime 言語切替、フォールバック動作に対応。 |
...
6. CSV の翻訳列を入力し、対応しているシーン名やストーリーカード翻訳をプロジェクトへインポートします。

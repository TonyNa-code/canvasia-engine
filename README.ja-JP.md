...
- Ren'Py draft export により、シーン、台詞、ナレーション、ADV / NVL / 映画字幕レイアウト、選択肢、基本的な背景 / 立ち絵 / BGM、名前付き小道具 / 前景 / Cut-in レイヤー、待機、ジャンプを `.rpy` の下書きへ変換し、手作業で確認すべきカスタム演出を migration notes として出力

...
- OpenAI Image を利用した背景、立ち絵、CG、UI 素材生成の任意機能。プロンプト、モデル名、形式、返却ファイルの検証とローカルのみの API Key 利用に対応
...
| 素材管理 | Available | インポート、置き換え、削除、使用中保護、容量予算ヒント、プロンプト / モデル / 形式検証付きの任意 OpenAI Image 生成に対応。 |

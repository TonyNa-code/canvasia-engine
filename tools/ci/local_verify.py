...
PYTHON_SYNTAX_FILES = [
    ...
    "export_runtime_module_registry.py",
    ...
    "renpy_export.py",
    "project_variable_migration.py",
    "run_editor.py",
    "native_runtime/runtime_player.py",
    "native_runtime/runtime_i18n.py",
    "native_runtime/runtime_player_settings.py",
    "native_runtime/runtime_settings_overlay.py",
    "native_runtime/runtime_system_menu.py",
    "native_runtime/runtime_save_vault.py",
    "native_runtime/runtime_reading_profiles.py",
    "native_runtime/runtime_dialogue_layouts.py",
    "native_runtime/runtime_dialog_panel.py",
    "native_runtime/runtime_visual_comfort.py",
    "native_runtime/runtime_speaker_focus.py",
    "native_runtime/runtime_dialogue_camera.py",
    "native_runtime/runtime_voice_reactive_motion.py",
    "native_runtime/runtime_character_renderer.py",
    "native_runtime/runtime_stage_renderer.py",
    "native_runtime/runtime_surface_cache.py",
    "native_runtime/runtime_voice_mixer.py",
    ...
    "native_runtime/runtime_timed_choices.py",
    "native_runtime/runtime_rollback.py",
    "native_runtime/runtime_text_history.py",
    "native_runtime/runtime_text_history_overlay.py",
    "native_runtime/runtime_save_slots.py",
    "native_runtime/runtime_save_overlay.py",
    ...
    "native_runtime/runtime_story_flow.py",
    "native_runtime/runtime_achievements.py",
    "native_runtime/runtime_credits.py",
    ...
    "tests/test_export_runtime_module_registry.py",
    ...
    "tests/test_native_runtime_rollback.py",
    "tests/test_native_runtime_input.py",
    "tests/test_native_runtime_save_thumbnails.py",
...
def build_node_check_steps() -> list[VerifyStep]:
    ...
    script_paths.extend(
        [
            ...
            "export_player_template/runtime_ui_skin.js",
            ...
            "export_player_template/runtime_asset_pipeline.js",
            ...
            "export_player_template/runtime_character_cards.js",
            "export_player_template/runtime_dialogue_camera.js",
            "export_player_template/runtime_voice_reactive_motion.js",
...
def build_release_tooling_steps(python_executable: str) -> list[VerifyStep]:
    return [
        ...
        build_unittest_step("Export runtime module registry", "test_export_runtime_module_registry.py", "release-tests", python_executable),
        ...
        build_unittest_step("Native runtime rollback helpers", "test_native_runtime_rollback.py", "release-tests", python_executable),
        build_unittest_step("Native runtime text history helpers", "test_native_runtime_text_history.py", "release-tests", python_executable),
        build_unittest_step("Native runtime text history overlay", "test_native_runtime_text_history_overlay.py", "release-tests", python_executable),
        build_unittest_step("Native runtime storage recovery", "test_native_runtime_storage.py", "release-tests", python_executable),
        build_unittest_step("Native runtime save vault", "test_native_runtime_save_vault.py", "release-tests", python_executable),
        build_unittest_step("Native runtime system menu", "test_native_runtime_system_menu.py", "release-tests", python_executable),
        build_unittest_step("Native runtime save slot protection", "test_native_runtime_save_slots.py", "release-tests", python_executable),
        build_unittest_step("Native runtime save overlay", "test_native_runtime_save_overlay.py", "release-tests", python_executable),
        build_unittest_step("Native runtime controller input helpers", "test_native_runtime_input.py", "release-tests", python_executable),
        ...
        build_unittest_step("Native runtime dialog panel cache", "test_native_runtime_dialog_panel.py", "release-tests", python_executable),
        build_unittest_step("Native adaptive preload helpers", "test_native_runtime_preload.py", "release-tests", python_executable),
        ...
        build_unittest_step("Native adaptive particle helpers", "test_native_runtime_particles.py", "release-tests", python_executable),
        build_unittest_step("Particle quality cross-runtime contract", "test_particle_quality_contract.py", "release-tests", python_executable),
        ...
        build_unittest_step("Native speaker focus helpers", "test_native_runtime_speaker_focus.py", "release-tests", python_executable),
        build_unittest_step("Speaker focus cross-runtime contract", "test_speaker_focus_contract.py", "release-tests", python_executable),
        build_unittest_step("Native dialogue camera helpers", "test_native_runtime_dialogue_camera.py", "release-tests", python_executable),
        build_unittest_step("Dialogue camera cross-runtime contract", "test_dialogue_camera_contract.py", "release-tests", python_executable),
        build_unittest_step("Native voice reactive motion helpers", "test_native_runtime_voice_reactive_motion.py", "release-tests", python_executable),
        build_unittest_step("Voice reactive motion cross-runtime contract", "test_voice_reactive_motion_contract.py", "release-tests", python_executable),
        build_unittest_step("Native stage renderer helpers", "test_native_runtime_stage_renderer.py", "release-tests", python_executable),
        build_unittest_step("Native surface transform cache", "test_native_runtime_surface_cache.py", "release-tests", python_executable),
        ...
        build_unittest_step("Native rich story text helpers", "test_native_runtime_story_text.py", "release-tests", python_executable),
        build_unittest_step("Rich story text cross-runtime contract", "test_story_text_contract.py", "release-tests", python_executable),
        build_unittest_step("Native music transport helpers", "test_native_runtime_music_transport.py", "release-tests", python_executable),
        build_unittest_step("Music transport cross-runtime contract", "test_music_transport_contract.py", "release-tests", python_executable),
        build_unittest_step("Native video transport helpers", "test_native_runtime_video_transport.py", "release-tests", python_executable),
        build_unittest_step("Video transport cross-runtime contract", "test_video_transport_contract.py", "release-tests", python_executable),
        build_unittest_step("Native playback lifecycle helpers", "test_native_runtime_playback_lifecycle.py", "release-tests", python_executable),
        build_unittest_step("Playback lifecycle cross-runtime contract", "test_playback_lifecycle_contract.py", "release-tests", python_executable),
        build_unittest_step("Native SFX transport helpers", "test_native_runtime_sfx_transport.py", "release-tests", python_executable),
        build_unittest_step("SFX transport cross-runtime contract", "test_sfx_transport_contract.py", "release-tests", python_executable),
        ...
        build_unittest_step("Native credits helpers", "test_native_runtime_credits.py", "release-tests", python_executable),
        build_unittest_step("Achievement cross-runtime contract", "test_achievement_cross_runtime_contract.py", "release-tests", python_executable),
        build_unittest_step("Unlockable manifest export contract", "test_export_unlockable_manifest.py", "release-tests", python_executable),
